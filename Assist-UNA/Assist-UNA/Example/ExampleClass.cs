 ...
 * ================================================================================================
 * 
 * Description: This class is here to serve as an example for coding standards. The programmers 
 *              will adhere to the commenting standards that are evident in this example.
 *                            
 * ================================================================================================        
 * 
 * Modification History
 * --------------------
 * 03/08/2014   THH     Original version.
 * 03/09/2014   AAH     Added awesomeness.
 * 03/13/2014   THH     Reformatted some of the commenting blocks to match the max length of the
 *                      stars. The max length of commenting is up to column 100.
 *  
 *************************************************************************************************/
...
namespace Processing
{
    ...
    class ExampleClass
    {
         ...
         *              It also continues here. (include any non-returned output, i.e. printed to
         *              screen, pass-by-reference changes, etc.)
         *  
         *****************************************************************************************/
         ...
         * Return:      N/A
         * 
         * Description: This method works just to practice with converting integers to base 16 and
         *              back. The examples are printed out to the console.
         *  
         *****************************************************************************************/
         ...
         * Return:      True/False
         * 
         * Description: This method prints the number that was passed to it to the console. 
         *              (include any non-returned output, i.e. printed to screen, pass-by-reference 
         *              changes, etc.).
         *  
         *****************************************************************************************/
         ...
         *              First Last
         *              
         * Input:       Number to be returned. (include slight description of input)
         * Return:      True/False
         * 
         * Description: This method prints the number that was passed to it to the console.
         *  
